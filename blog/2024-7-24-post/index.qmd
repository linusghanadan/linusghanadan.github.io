...
**Context for plot**: For a project in my Geospatial Analysis class, I used data from the EPA’s Environmental Justice Screening and Mapping Tool (EJScreen) to create this chloropleth maps analyzing the relationship between PM 2.5 concentrations and race demographics among counties in the State of Maryland.
