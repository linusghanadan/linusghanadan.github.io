...
#### Simple linear regression based on SLR
...
```{r}
# JUST CALCULATE CONFIDENCE INTERVAL
nitr_trend_reg <- lm(trend ~ yr_mo, data = nitr_decomp_yearly)
summary(nitr_trend_reg)
```

```{r}
# JUST CALCULATE CONFIDENCE INTERVAL
phos_trend_reg <- lm(trend ~ yr_mo, data = phos_decomp_yearly)
