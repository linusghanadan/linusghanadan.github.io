...
**Context for plot**: For a project in my Geospatial Analysis class, I retrieved grid-cell data on Phoenix's Biodiversity Intactness Index (BII), which is a score rating an area of land's biodiversity from 0 to 1. The purpose of this analysis was to better understand and visualize biodiversity in Phoenix, as well as highlight areas where biodiversity declined from being highly biodiverse (BII>0.75) in 2017 to being only moderately biodiverse (BII<0.75) in 2020.

**Caption**: The North East area of Phoenix and South Central Phoenix had the highest BII in 2020. In addition, some locations at the outer edges of these areas experienced a decrease in BII from 2017 to 2020, with BII being >0.75 in 2017 and <0.75 in 2020 (shown in red).
