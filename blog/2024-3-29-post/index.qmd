...
maxwell_tracks <- read.csv(here::here("data", "2024-3-29-post-data", "linus_tracks.csv")) %>% 
  mutate(name = "maxwell")
...
In the SGB model, which was the best performing model, tempo was the most important feature for predicting whether a song was in my collection or Maxwell's, with an importance close to 0.20. Valence, danceability, energy, and instrumentalness were also important features.
